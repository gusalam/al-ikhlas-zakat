            ...
            <div style={{ border: '1px solid #276749', padding: '0', display: 'flex', minHeight: '320px' }}>
              ...
              <div style={{ flex: 1, padding: '12px 16px', fontSize: '13px' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
                  <tbody>
                    <tr>
                      <td style={{ width: '120px', padding: '3px 0' }}>Nomor</td>
                      <td style={{ width: '10px' }}>:</td>
                      <td><strong style={{ border: '1px solid #ccc', padding: '1px 8px' }}>{data.nomor}</strong></td>
                    </tr>
                    <tr>
                      <td style={{ padding: '3px 0' }}>Nama Muzakki</td>
                      <td>:</td>
                      <td><strong>{data.nama_muzakki}</strong></td>
                      <td style={{ textAlign: 'right' }}>Jumlah Jiwa : <strong style={{ border: '1px solid #ccc', padding: '1px 8px' }}>{data.jumlah_jiwa}</strong> Orang</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '12px', alignItems: 'center' }}>
                  <div>
                    ...
                    <strong style={{ marginLeft: '20px' }}>Rp    {fmt(totalUang)}</strong>
                  </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '12px' }}>
                  <div>
                    <span>Terbilang : </span>
                    <strong style={{ fontSize: '13px' }}>{terbilang(totalUang)}</strong>
                  </div>
